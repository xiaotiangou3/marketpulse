...
def main():
    print("==================================================")
    print("   MARKETPULSE FULL AI INTEGRATION TEST SUITE     ")
    print("==================================================")
    ...
    try:
        ...
        print("\n  ========================================")
        print("  [BULL PERSPECTIVE]")
        print("  ========================================")
        print(analysis_result['bull'][:400] + "...")
        
        print("\n  ========================================")
        print("  [BEAR PERSPECTIVE]")
        print("  ========================================")
        print(analysis_result['bear'][:400] + "...")
        
        print("\n  ========================================")
        print("  [SYNTHESIZED INVESTMENT REPORT]")
        print("  ========================================")
        print(analysis_result['synthesis'][:500] + "...")
        ...
        print("\n  ========================================")
        print("  [MACRO STRESS RISK REPORT]")
        print("  ========================================")
        print(stress_report[:500] + "...")
        ...
        print("\n==================================================")
        print("   FULL AI INTEGRATION TEST COMPLETED SUCCESSFULLY!")
        print("==================================================")
